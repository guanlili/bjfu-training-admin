...
export declare const paginationProps: {
    ...
    readonly pagerCount: import("@element-plus/utils/props").BuildPropReturn<NumberConstructor, 7, unknown, unknown, unknown>;
    readonly layout: import("@element-plus/utils/props").BuildPropReturn<StringConstructor, string, unknown, unknown, unknown>;
    readonly pageSizes: import("@element-plus/utils/props").BuildPropReturn<import("@element-plus/utils/props").PropWrapper<number[]>, () => [10, 20, 30, 40, 50, 100], unknown, unknown, unknown>;
    readonly popperClass: import("@element-plus/utils/props").BuildPropReturn<StringConstructor, "", unknown, unknown, unknown>;
    readonly prevText: import("@element-plus/utils/props").BuildPropReturn<StringConstructor, "", unknown, unknown, unknown>;
    readonly nextText: import("@element-plus/utils/props").BuildPropReturn<StringConstructor, "", unknown, unknown, unknown>;
