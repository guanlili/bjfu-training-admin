...
export declare const createModelToggleComposable: (name: string) => {
    ...
    useModelToggleProps: {
        [x: string]: import("@element-plus/utils/props").BuildPropReturn<import("@element-plus/utils/props").PropWrapper<boolean | null>, null, false, never, never> | import("@element-plus/utils/props").BuildPropReturn<import("@element-plus/utils/props").PropWrapper<(val: boolean) => void>, never, false, never, never>;
    };
