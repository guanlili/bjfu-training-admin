...
declare const _default: import("vue").DefineComponent<{
    ...
    readonly resize: import("../../../utils/props").BuildPropReturn<StringConstructor, unknown, unknown, "both" | "none" | "horizontal" | "vertical", unknown>;
    ...
    readonly inputStyle: import("../../../utils/props").BuildPropReturn<import("../../../utils/props").PropWrapper<StyleValue>, () => import("@element-plus/utils/types").Mutable<{}>, unknown, unknown, unknown>;
}, {
    input: import("vue").Ref<HTMLInputElement | undefined>;
    textarea: import("vue").Ref<HTMLTextAreaElement | undefined>;
    attrs: import("vue").ComputedRef<Record<string, unknown>>;
    inputSize: import("vue").ComputedRef<import("@element-plus/utils/types").ComponentSize>;
    ...
    resize?: import("../../../utils/props").BuildPropType<StringConstructor, "both" | "none" | "horizontal" | "vertical", unknown> | undefined;
    ...
    type: string;
    resize: import("../../../utils/props").BuildPropType<StringConstructor, "both" | "none" | "horizontal" | "vertical", unknown>;
    form: string;
    label: string;
    autocomplete: string;
    disabled: boolean;
