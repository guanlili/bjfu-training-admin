...
export declare const useCheckboxGroup: () => {
    ...
    elFormItemSize: import("vue").ComputedRef<import("@element-plus/utils/types").ComponentSize | undefined>;
...
export declare const useCheckbox: (props: IUseCheckboxProps) => {
    ...
    checkboxSize: import("vue").ComputedRef<import("@element-plus/utils/types").ComponentSize>;
    model: import("vue").WritableComputedRef<any>;
    handleChange: (e: InputEvent) => void;
    focus: import("vue").Ref<boolean>;
    size: import("vue").ComputedRef<import("@element-plus/utils/types").ComponentSize>;
};
