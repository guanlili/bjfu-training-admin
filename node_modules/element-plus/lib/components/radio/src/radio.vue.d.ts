declare const _default: import("vue").DefineComponent<{
    ...
    readonly label: import("../../../utils/props").BuildPropReturn<(StringConstructor | BooleanConstructor | NumberConstructor)[], string, unknown, unknown, unknown>;
}, {
    ...
    name: string;
    border: boolean;
    label: import("../../../utils/props").BuildPropType<(StringConstructor | BooleanConstructor | NumberConstructor)[], unknown, unknown>;
    disabled: boolean;
