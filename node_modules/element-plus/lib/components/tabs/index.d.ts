export declare const ElTabs: import("../../utils/types").SFCWithInstall<import("vue").DefineComponent<{
    ...
    readonly tabPosition: import("../../utils/props").BuildPropReturn<StringConstructor, "top", unknown, "left" | "top" | "bottom" | "right", unknown>;
    ...
    modelValue: string;
    activeName: string;
    tabPosition: import("../../utils/props").BuildPropType<StringConstructor, "left" | "top" | "bottom" | "right", unknown>;
