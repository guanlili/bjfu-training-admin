...
export declare const tabsProps: {
    readonly type: import("@element-plus/utils/props").BuildPropReturn<StringConstructor, "", unknown, "" | "card" | "border-card", unknown>;
    readonly activeName: import("@element-plus/utils/props").BuildPropReturn<StringConstructor, "", unknown, unknown, unknown>;
    readonly closable: BooleanConstructor;
    readonly addable: BooleanConstructor;
    readonly modelValue: import("@element-plus/utils/props").BuildPropReturn<StringConstructor, "", unknown, unknown, unknown>;
    readonly editable: BooleanConstructor;
    readonly tabPosition: import("@element-plus/utils/props").BuildPropReturn<StringConstructor, "top", unknown, "left" | "top" | "bottom" | "right", unknown>;
    readonly beforeLeave: import("@element-plus/utils/props").BuildPropReturn<import("@element-plus/utils/props").PropWrapper<(newTabName: string, oldTabName: string) => void | boolean | Promise<void | boolean>>, () => boolean, unknown, unknown, unknown>;
...
declare const _default: import("vue").DefineComponent<{
    ...
    readonly editable: BooleanConstructor;
    readonly tabPosition: import("@element-plus/utils/props").BuildPropReturn<StringConstructor, "top", unknown, "left" | "top" | "bottom" | "right", unknown>;
    readonly beforeLeave: import("@element-plus/utils/props").BuildPropReturn<import("@element-plus/utils/props").PropWrapper<(newTabName: string, oldTabName: string) => boolean | void | Promise<boolean | void>>, () => boolean, unknown, unknown, unknown>;
    readonly stretch: BooleanConstructor;
    ...
    type: import("@element-plus/utils/props").BuildPropType<StringConstructor, "" | "card" | "border-card", unknown>;
    stretch: boolean;
    closable: boolean;
    modelValue: string;
    activeName: string;
    tabPosition: import("@element-plus/utils/props").BuildPropType<StringConstructor, "left" | "top" | "bottom" | "right", unknown>;
