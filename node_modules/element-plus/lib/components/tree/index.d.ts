...
declare const _Tree: SFCWithInstall<import("vue").DefineComponent<{
    ...
    el$: import("vue").Ref<import("@element-plus/utils/types").Nullable<HTMLElement>>;
    dropIndicator$: import("vue").Ref<import("@element-plus/utils/types").Nullable<HTMLElement>>;
